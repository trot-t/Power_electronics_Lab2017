...
\begin{tabular}{clcccc p{.4cm}|p{.4cm}|p{.4cm}|p{.4cm}|p{.4cm}}% @{}}
  \multicolumn{11}{c}{График выполнения лабораторных работ студентами 4405 группы} \\
\toprule
...
\midrule
	&&\rotatebox{90}{лаб.3} & & \rotatebox{90}{лаб.5} &\\
	&Халявин Дмитрий	&\OK&&\OK&\\
	&Смирнов Никита		&\OK&&\OK&\\
